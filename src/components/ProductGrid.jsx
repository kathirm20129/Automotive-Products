...
const products = [
    ...
    {
        id: 2,
        name: "Аккумулятор 60Ah 540A",
        sku: "SKU: 87654321",
        price: "5 450 ₽",
        oldPrice: "6 200 ₽",
        rating: 4.5,
        reviews: 8,
        image: product1 // Placeholder for now
    },
    {
        id: 3,
        name: "Фильтр масляный синтетический",
        sku: "SKU: 11223344",
        price: "850 ₽",
        oldPrice: "1 100 ₽",
        rating: 4.9,
    ...
    {
        id: 4,
        name: "Свечи зажигания Platinum (4 шт)",
        sku: "SKU: 55667788",
        price: "1 800 ₽",
        oldPrice: "2 400 ₽",
        rating: 4.7,
    ...
    return (
        <section className="max-w-7xl mx-auto px-4 py-12">
            <div className="flex justify-between items-end mb-8">
                <div>
                    <h2 className="text-2xl font-black text-navy uppercase tracking-tight">Популярные товары</h2>
